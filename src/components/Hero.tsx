    ...
    <div className="relative bg-gray-900">
      ...
      <div className="relative z-10 flex items-start h-screen pt-24">
        <div className="container mx-auto px-4 text-center text-white">
          ...
          <p className="text-sm md:text-lg mb-8 max-w-3xl mx-auto">
          ...
          <div className="flex justify-center mb-8">
            <button className="inline-flex items-center justify-center bg-primary hover:bg-primary/90 text-white px-6 py-3 rounded-lg text-lg font-medium transition-colors">
              <a href="tel:+34981135535" className="flex items-center">
                <svg className="mr-2 h-5 w-5 transform rotate-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="flex flex-col items-center mt-16">
            <p className="text-base md:text-lg font-semibold mb-2">Descúbrenos</p>
            <a href="#who" className="flex items-center cursor-pointer animate-bounce">
              <svg className="h-12 w-12 md:h-16 md:w-16 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
